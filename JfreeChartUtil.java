...
public final class JfreeChartUtil{
	 ...
	 * Map 对象必须包含  <KEY,VALUE>对  <"NUM",数量>  <"SERIES_INDEX",子维度> <"CATEGORY",对象> 
	 * @return CategoryDataset 报表数据
	 */
	 private static CategoryDataset converListToCategoryDataset( List<Map<String,String>> data){
		DefaultCategoryDataset dataset = new DefaultCategoryDataset(); 
		for(Map<String,String> item : data){
			dataset.addValue(Double.valueOf(item.get("NUM")),item.get("SERIES_INDEX"),item.get("CATEGORY"));
		}
		return dataset;
	 }
	 /**
	  * 数据库结果转报表数据类型（饼图） 
	  * @param data   List<Map<String,String>> data  
	  * Map 对象必须包含  <KEY,VALUE>对   <"NUM",数量> <"OBJ",对象> 
	  * @return PieDataset 报表数据
	  */
	 private static PieDataset converListToPieDataset( List<Map<String,String>> data){
	...
	public static JFreeChart createBarChart(CategoryDataset dataset, String title,  
            								String xtitle, String ytitle,boolean is3D,String url) {
        ...
        //设置鼠标移动展现内容
        //renderer.setBaseToolTipGenerator(new StandardCategoryToolTipGenerator("{2}",NumberFormat.getNumberInstance())); 
        //设置Url
        ...
        ItemLabelPosition itemLabelPosition= new ItemLabelPosition(ItemLabelAnchor.INSIDE12
        								,TextAnchor.CENTER_RIGHT,TextAnchor.CENTER_RIGHT,-1.57D);
	 ...
	 * @return 		  JFreeChart
	 */
	public static JFreeChart createPieChart(PieDataset dataset, String title,boolean is3D,String url) {
	 ...
	 * @return 		  JFreeChart
	 */
	public static JFreeChart createXYLineChart(DefaultCategoryDataset dataSet,String title,String xtitle,String ytitle,boolean is3D) {
	 ...
	 * @return 		  JFreeChart
	 */
    public static String createMeterChart(HttpSession session , PrintWriter pw)throws Exception{
